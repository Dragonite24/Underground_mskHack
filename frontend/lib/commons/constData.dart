...
List<UserData> dummyUserDataListInSearch = [
  UserData('Юлия', '21 / 5km', 'Nice to meet you', [
...
List<UserData> dummyUserDataListInLounge() {
  return [
    UserData(
        'Jessi',
        '21 / 11km',
        'I haven’t dated much in recent years because I’ve been so focused on my career.',
        [
    ...
    UserData(
        'Lucy',
        '23 / 4km',
        'If I could play one sport professionally, it would be soccer because I feel like it’s the least harmful.',
        ['https://cdn.pixabay.com/photo/2017/06/24/02/56/art-2436545_1280.jpg'],
        ['Game', 'Business', 'Meet']),
    UserData('Lia', '22 / 42km',
        'My family. I know it sounds corny, but I’m not ashamed to say it.', [
