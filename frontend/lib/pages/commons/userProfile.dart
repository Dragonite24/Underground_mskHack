import 'package:Underground/pages/commons/userProfileCommon.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:Underground/setting/editProfile.dart';
...
class _UserProfile extends State<UserProfile> with userProfileCommon {
  List<Choice> choices = <Choice>[
    const Choice(title: 'Редактировать', icon: Icons.edit),
    const Choice(title: 'Удалить', icon: Icons.delete_outline),
  ];

  void _select(Choice choice) {
    if (choice.title == 'Редактировать') {
      Navigator.push(
        context,
        MaterialPageRoute(
